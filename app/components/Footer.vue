...
<template>
	<footer class="w-full">
		...
		>
			...
			<div class="second-row flex h-3">
				<div class="red flex-1 bg-red-500 rounded-l" />
				<div class="orange flex-1 bg-orange-500" />
				<div class="light-orange flex-1 bg-orange-300" />
				<div class="indigo flex-1 bg-indigo-500 rounded-r" />
			</div>
		</UCard>
	</footer>
</template>
