...
const baseResume = {
  personalInfo: {
    ...
    summary: "",
    // Will be set after experiences are defined
  ...
  selectedProjects: [
    {
      ...
      description: "Full recording suite that captures camera, audio, and screen feeds without third-party SDKs.",
      impact: "Expanded ourBuddy.ai’s platform capabilities while cutting vendor costs and latency.",
      stack: [
        "React",
        "Next.js",
        "TypeScript",
    ...
    },
    {
      ...
      description: "Drag-and-drop interface that lets CDN operators compose complex Lua conditions safely.",
      impact: "Reduced policy configuration time by 60% and eliminated syntax errors before deployment.",
    ...
    {
      title: "Vue Formik",
      description: "Open-source Vue.js library that brings Formik-style declarative form patterns to Vue 3.",
      impact: "Adopted by 1k+ developers, enabling consistent validation and DX improvements.",
  ...
  experiences: [
    {
      ...
      description: "A vital internet intermediary that powers CDN services, custom nodes, DNS acceleration, and SSL offerings for global customers.",
      ...
      projects: [
        ...
        },
        {
          ...
          description: "Led development of a key account management platform for strategic client relationships.",
          job: [
        ...
        },
        {
          ...
          description: "ChatGPT-like AI portal for querying employee calendars, daily work records from Drive, and other company data via conversational chat.",
          job: [
      ...
      projects: [
        {
          ...
          description: "Engineered a versatile recording system for audio, video, screen capture and video with screen captures.",
          job: [
    ...
    {
      company: "Dimitra",
      description: "Global AgTech company delivering digital products that help smallholder farmers improve yields and supply-chain visibility.",
...
export { Resume as R };
//# sourceMappingURL=resume-CN0FSVbL.mjs.map
