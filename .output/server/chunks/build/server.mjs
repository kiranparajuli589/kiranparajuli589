import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, toValue as toValue$2, effectScope, shallowRef, watchEffect, readonly, ref, provide, inject, watch, h as h$1, markRaw, computed, getCurrentInstance, toRef as toRef$1, camelize, createBlock, createCommentVNode, unref, openBlock, Teleport, renderSlot, withCtx, mergeModels, useModel, mergeProps, createVNode, createTextVNode, toDisplayString, Suspense, resolveComponent, resolveDynamicComponent, nextTick, toRefs, useSlots, hasInjectionContext, customRef, Comment, cloneVNode, getCurrentScope, onScopeDispose, isRef, shallowReactive, Fragment, toHandlerKey, onServerPrefetch, reactive, createElementBlock, defineAsyncComponent, useSSRContext, createApp, renderList, useId, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle } from 'vue';
import { j as parseQuery, k as defu, l as klona, m as defuFn, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as withTrailingSlash, t as withoutTrailingSlash, v as getContext, c as createError$1, $ as $fetch$1, x as baseURL, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1 } from '../nitro/nitro.mjs';
...
const unhead_V9Bxd6jenKttQ_RwGPVAyjOCRnjySwlmBj8n0vzHEuc = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-67ok7Fgi.mjs')
  },
  {
    name: "resume",
    path: "/resume",
    component: () => import('./resume-C2vWyKhk.mjs')
  },
  {
    name: "resume-pdf",
    path: "/resume-pdf",
    meta: __nuxt_page_meta || {},
    component: () => import('./resume-pdf-FLd77ZAz.mjs')
  },
  {
    name: "blog-name",
    path: "/blog/:name()",
    component: () => import('./_name_-COXu8PgO.mjs')
  },
  {
    name: "blogs",
    path: "/blogs",
    component: () => import('./index-DcUf4WLz.mjs')
  },
  {
    name: "cover-letter",
    path: "/cover-letter",
    component: () => import('./cover-letter-CGafoO4d.mjs')
  }
];
...
const revive_payload_server_4v2zfvl6htm_XlB1bLE8J__YkQUHQHVF34KXNCB5Yzg = /* @__PURE__ */ defineNuxtPlugin({
...
const colors_kanZSTscvYVPZtNPjtUrGpFKeVbyJtrCAVnjNvkBKfE = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_DjhyhuaRw_FQAzofnOJPmrRC8ZAKDoGyQUz8JdScHhQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const plugins = [
  payloadPlugin,
  unhead_V9Bxd6jenKttQ_RwGPVAyjOCRnjySwlmBj8n0vzHEuc,
  plugin$1,
  revive_payload_server_4v2zfvl6htm_XlB1bLE8J__YkQUHQHVF34KXNCB5Yzg,
  plugin,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_kanZSTscvYVPZtNPjtUrGpFKeVbyJtrCAVnjNvkBKfE,
  plugin_DjhyhuaRw_FQAzofnOJPmrRC8ZAKDoGyQUz8JdScHhQ
];
...
function reactiveOmit(obj, ...keys) {
  ...
  return reactiveComputed(() => typeof predicate === "function" ? Object.fromEntries(Object.entries(toRefs(obj)).filter(([k2, v]) => !predicate(toValue$2(v), k2))) : Object.fromEntries(Object.entries(toRefs(obj)).filter((e) => !flatKeys.includes(e[0]))));
}
typeof WorkerGlobalScope !== "undefined" && globalThis instanceof WorkerGlobalScope;
...
function reactivePick(obj, ...keys) {
  const flatKeys = keys.flat();
  const predicate = flatKeys[0];
  return reactiveComputed(() => typeof predicate === "function" ? Object.fromEntries(Object.entries(toRefs(obj)).filter(([k2, v]) => predicate(toValue$2(v), k2))) : Object.fromEntries(flatKeys.map((k2) => [k2, toRef(obj, k2)])));
}
...
_sfc_main$d.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_3b5b7d656f8d69f13a3726b0c89ea276/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0$1 = Object.assign(_sfc_main$3, { __name: "UApp" });
const layouts = {
  default: defineAsyncComponent(() => import('./default-JjreoeCu.mjs').then((m) => m.default || m)),
  "pdf-view": defineAsyncComponent(() => import('./pdf-view-2f1skPkL.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dr_uKFIy.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-PVprhMhr.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.24_db0@0.3.4_3721b1c77a28704112b6f925a4a72940/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.24_db0@0.3.4_3721b1c77a28704112b6f925a4a72940/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { createGlobalState as A, AUTOFOCUS_ON_MOUNT as B, focusFirst as C, getTabbableCandidates as D, focus as E, AUTOFOCUS_ON_UNMOUNT as F, EVENT_OPTIONS as G, getTabbableEdges as H, computedEager as I, useCollection as J, useForwardProps as K, useResizeObserver as L, isDef as M, useFormField as N, useFieldGroup as O, Primitive as P, useComponentIcons as Q, looseToNumber as R, usePortal as S, Teleport_default as T, isArrayOfArray as U, VisuallyHidden_default as V, _sfc_main$c as W, getDisplayValue as X, useToast as Y, __nuxt_component_0 as Z, __nuxt_component_0$3 as _, _sfc_main$b as a, _sfc_main$d as b, useVModel as c, createContext as d, entry_default as default, useForwardExpose as e, useEventListener as f, Presence_default as g, useAppConfig as h, isNullish as i, useForwardPropsEmits as j, get as k, useAppStore as l, _sfc_main$8 as m, useRoute as n, navigateTo as o, createSharedComposable$1 as p, tryOnBeforeUnmount as q, reactivePick as r, injectConfigProviderContext as s, tv as t, useHead as u, toValue$1 as v, unrefElement as w, refAutoReset as x, getActiveElement as y, onKeyStroke as z };
